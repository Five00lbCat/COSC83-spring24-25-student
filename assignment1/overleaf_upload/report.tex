...
\begin{figure}[h!]
  ...
  \end{subfigure}
  \caption{Gaussian filter (checkerboard) for $\sigma \in \{0.5, 1.0, 2.0\}$ (rows) and
           $k \in \{3, 7, 15\}$ (columns).}
  \label{fig:gaussian}
\end{figure}
...
\begin{figure}[h!]
  ...
  \begin{subfigure}[b]{0.85\linewidth}
    ...
    \caption{Noisy test image.}
  \end{subfigure}
  \caption{Gaussian filter (noisy image) for $\sigma \in \{0.5, 1.0, 2.0\}$ (rows) and
           $k \in \{3, 7, 15\}$ (columns).
...
\begin{figure}[h!]
  ...
  \end{subfigure}
  \caption{Gaussian filter (natural image) for $\sigma \in \{0.5, 1.0, 2.0\}$ (rows) and
           $k \in \{3, 7, 15\}$ (columns).
